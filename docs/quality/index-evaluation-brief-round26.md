# Penguin Knowledge Evaluation Brief — Round 26

## 1. Mission

Run a genuinely fresh, black-box acceptance evaluation of the currently installed Penguin Knowledge runtime. Round 26 is a new dynamic scenario set. It retests the complete engineering-investigation surface while directly targeting the remaining Round 25 defects: bounded multi-term search, truthful file-count reconciliation, MCP safety annotations, owner-mutation discoverability without mutation, typed cursor/root failures, and actionable remediation.
...
- Codex: `/Users/shieng/Desktop/Pengvi/docs/quality/index-evaluation-codex-round26.md`
- Claude Code: `/Users/shieng/Desktop/Pengvi/docs/quality/index-evaluation-claude-opus-5-round26.md`
...
Both independent reports must score 95–100. One must come from a genuinely fresh Claude Code OS process and one from a genuinely fresh Codex OS process. Both must use Penguin MCP only and pass every hard gate. Anything less keeps the implementation open.

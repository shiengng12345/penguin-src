...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            knowledge::knowledge_corpus_control,
            knowledge::knowledge_corpus_reconcile,
            ...
            knowledge::knowledge_runtime_sync,
            knowledge::knowledge_runtime_health,
            knowledge::knowledge_runtime_restart_required,

//! Connection CRUD and health-probe commands — `broker_list_connections`,
//! `broker_upsert_connection`, `broker_delete_connection`,
//! `broker_test_connection` — and their DTO/helper support. Split out of the
//! former single-file `commands.rs` (Phase A Task 4, pure move: no behaviour
...
use super::{load_row, now_ms, resolve_secret, KEYCHAIN_SERVICE};
